...
# 1. 使用你刚写的带 P2 头的 yaml 文件初始化一个全新的模型结构
    model = YOLO('/home/zhanghangning/ultralytics/ultralytics/cfg/models/12/yolo12-nwd+ghost--.yaml') 
    ...
    model.train(
        ...
        name='yolo12_ghost+nwd--', # 给这次训练起个名字，你的结果会存在 runs/train/yolo12_ghost+nwd 目录下
