...
if __name__ == '__main__':
    # 1. 直接加载你手里的模型文件 (同时包含了网络结构和预训练权重)
    model = YOLO('/home/zhanghangning/ultralytics/yolo12n.pt') 
    ...
    model.train(
        ...
        name='yolo12_nwd+p2+ASFF', # 给这次训练起个名字，你的结果会存在 runs/train/yolo26_evd4uav 目录下
